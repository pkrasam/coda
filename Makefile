...
ledgers_in_frontier_diagram: SHELL := /bin/bash
ledgers_in_frontier_diagram:
	cd docs/res; pdflatex ledgers_in_frontier.tex && convert -density 600x600 ledgers_in_frontier.pdf -quality 90 -resize 1080x800 ledgers_in_frontier.png



diagrams: transition_frontier_diagram ledgers_in_frontier_diagram
...
.PHONY: all base-docker base-googlecloud base-minikube build check-format ci-base-docker clean codaslim containerstart deb dev codabuilder kademlia coda-docker coda-googlecloud coda-minikube ocaml407-googlecloud pull-ocaml407-googlecloud reformat test test-all test-coda-block-production-sig test-coda-block-production-stake test-codapeers-sig test-codapeers-stake test-full-sig test-full-stake test-runtest test-transaction-snark-profiler-sig test-transaction-snark-profiler-stake update-deps render-circleci check-render-circleci docker-toolchain-rust toolchains transition_frontier_diagram diagrams ledgers_in_frontier_diagram
